 ...
 * Relations Model
 *
 * @property \App\Model\Table\RelationTypesTable|\Cake\ORM\Association\BelongsTo $RelationTypes
...
class RelationsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['relation_type_id'], 'RelationTypes'));
        $rules->add($rules->existsIn(['user_id'], 'Users'));
        $rules->add($rules->existsIn(['distant_id'], 'Users'));
