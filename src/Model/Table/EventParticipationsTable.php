 ...
 *
 * @property \App\Model\Table\EventParticipationTypesTable|\Cake\ORM\Association\BelongsTo $EventParticipationTypes
...
class EventParticipationsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('EventParticipationTypes', [
            'foreignKey' => 'event_participation_type_id'
        ]);
    ...
    {
        $rules->add($rules->existsIn(['event_participation_type_id'], 'EventParticipationTypes'));
